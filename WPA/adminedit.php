...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($updateStmt->execute()) {
        // Redirect back to manage appointments page after successful update
...
<body>
    ...
    <input type="button" value="Cancel" onclick="window.location.href='manage_appointments.php';"> <!-- Adjust href as needed -->
